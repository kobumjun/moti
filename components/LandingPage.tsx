...
function FeatureCard({
  ...
  return (
    <div className="p-6 rounded-xl bg-moti-surface border border-moti-border/50">
      <h3 className="font-semibold text-moti-text mb-2">{title}</h3>
      <p className="text-sm text-moti-textDim">{desc}</p>
    </div>
  );
}
